        ...
        <div className="resume-wrapper" data-aos="fade-right">
          <div className="resume-box">
            ...
            <div className="resume-details">
              <h5 className="resume-details-title">IT Support & Services</h5>
        ...
        <div className="resume-wrapper" data-aos="fade-right">
          ...
          <div className="resume-box">
            ...
            <div className="resume-details">
              ...
              <h6 className="resume-details-link"><Link to={`https://www.udemy.com/`} target="_blank">Udemy Course</Link></h6>
              <p>
          ...
          <div className="resume-box">
            ...
            <div className="resume-details">
              <h5 className="resume-details-title">Flutter & Dart to complete guid</h5>
              <h6 className="resume-details-link"><Link to={`https://www.udemy.com/`} target="_blank">Udemy Course</Link></h6>
              <p>
                In 2023 - I started and continue course from Maximilian Schwarzmuller about flutter framework to create functionality mobile application for both platforms IOS/Android.
              </p>
            </div>
          </div>
          <div className="resume-box">
