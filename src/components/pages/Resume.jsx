        ...
        <div className="resume-box">
          ...
          <div className="resume-details">
            ...
            <p>
              ...
              in Pyrzyce, on IT profile with specialization of web applications.
            </p>
          </div>
        </div>
        <div className="resume-box">
          ...
          <div className="resume-details">
            ...
            <p>
              ...
              (WSKZ in Wrocław) majoring in internal security in Poland in 2023.
            </p>
          </div>
        </div>
        <div className="resume-box">
        ...
        <div className="resume-box">
          ...
          <div className="resume-details">
            ...
            <p>
              ...
              how to use HTML, CSS & JS to combine into a tricky components for
              websites.
            </p>
          </div>
        </div>
        ...
        <div className="resume-box">
          ...
          <div className="resume-details">
            ...
            <p>
              ...
              completed the Introduction to Cybersecurity course. The holder of
              this student-level credential has introductory knowledge of
              cybersecurity, including the global implications of cyber threats
              on industries, and why cybersecurity is a growing profession. They
              understand vulnerabilities and threat detection and defense. They
              also have insight into opportunities available with pursuing
